import pandas as pd
import numpy as np
from StellarAnalytics.generation_spectre.randspectrum import get_elements_list, new_generate_spectrums
from StellarAnalytics.data_shaping import reshape, pca_2D
...
elements = get_elements_list(".StellarAnalytics/Data/Output")
